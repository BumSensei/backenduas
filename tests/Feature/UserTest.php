...
class UserTest extends TestCase
{
    ...
    public function testLoginSuccess()
    {
        ...
        $user = User::where('email','gent@gmail.com')->first();
    ...
    public function testUpdateFailed()
    {
        ...
        $this->patch('/api/v1/users/profile', 
            [
                'name' => 'Gent Admin Updated, but failed because of name validation failed, Gent Admin Updated, but failed because of name validation failed'
            ],
            [
                'Authorization' => '1234-5678'
            ]
